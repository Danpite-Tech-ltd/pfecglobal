        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="h-100 card card-body rounded p-4 pb-0">
                <div class="d-flex justify-content-between" >
                    ...
                    <a type="button" data-bs-toggle="modal" data-bs-target="#mainFaq" class="btn-sm btn btn-primary"
                        style="color:white;height: 30px;"> + Create Faq</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="card card-body rounded h-100 p-4">
                <div class="data-tables">
                    <table class="table table" id="faqinfo" width="100%" style="text-align: center;">
