...
<div class="container-fluid pt-4 px-4">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="bg-secondary rounded h-100 p-4">
                <h2 class="mb-4" style="text-align: center;color:red">Meta Information</h2>
                <form action="{{ url('/admin/metainfo/update', $webinfo->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="title"
                                    value="{{ $webinfo->title }}" id="floatingInput" placeholder="Website Title">
                                <label for="floatingInput">Website Title</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="meta_title"
                                    value="{{ $webinfo->meta_title }}" id="floatingPassword"
                                    placeholder="Meta Title">
                                <label for="floatingPassword">Meta Title</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="meta_keywords"
                                    value="{{ $webinfo->meta_keywords }}" id="floatingPassword"
                                    placeholder="Meta Keywords">
                                <label for="floatingPassword">Meta Keywords</label>
                            </div>
                            <div class="form-floating mb-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="m-3 ms-0" style="text-align: center;height: 156px;margin-top:50px !important">
                                <h4 style="width:30%;float: left;text-align: left;">META LOGO : </h4>
