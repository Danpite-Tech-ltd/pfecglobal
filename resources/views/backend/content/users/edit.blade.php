...
<div class="container-fluid pt-4 px-4">
    <form name="form" id="EditRole" method="POST" action="{{ route('admin.users.update', $user->id) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="name" id="floatingInput"
                                    placeholder="Your name here" value="{{ $user->name }}" required>
                                <label for="floatingInput" style="color: red">Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" name="email" id="floatingInput"
                                    placeholder="name@ayebazar.com" value="{{ $user->email }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="phone" id="floatingInput"
                                    placeholder="Type Phone" value="{{ $user->phone }}" required>
