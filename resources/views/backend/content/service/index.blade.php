...
@section('maincontent')
                ...
                <div class="modal-dialog">
                    <div class="rounded modal-content bg-secondary h-100">
                        <div class="modal-header">
                            <h5 class="modal-title" style="color: red;">Create New Resources</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form name="form" id="AddService" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 form-floating ">
                                    <textarea class="form-control" placeholder="Text" name="service_text"
                                        id="service_text_add" style="height: 80px;"></textarea>
                    ...
                    <div class="rounded modal-content bg-secondary h-100">
                        ...
                        <div class="modal-body">
                            ...
                            <form name="form" id="EditService" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 form-floating">
                                    <textarea class="form-control " placeholder="Text" name="service_text"
                                        id="service_text_edit" style="height: 80px;"></textarea>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#service_text_add, #service_text_edit').summernote({
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data == 'error') {
                            ...
                            $('#service_title').val('');
                            $('#service_text_add').summernote('code', '');
                            $('#service_image').val('');
                            $('#link').val('');
                            $('#subtitle').val('');
            ...
            $(document).on('click', '#editServiceBtn', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#EditService').find('#service_text_edit').summernote('code', data.service_text);
                        $('#EditService').find('#service_id').val(data.id);
                        $('#EditService').find('#link').val(data.link);
                        $('#EditService').find('#subtitle').val(data.subtitle);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data == 'error') {
                            ...
                            $('#EditService').find('#service_text_edit').summernote('code', '');
                            $('#EditService').find('#service_btn_name').val('');
                            $('#EditService').find('#service_btn_link').val('');
                            $('#EditService').find('#service_subtitle').val('');
