        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="h-100 bg-secondary rounded p-4 pb-0">
                ...
                <div class="" style="width: 50%;float:left;">
                    <a href="{{ route('admin.userroles.create') }}" class="btn btn-dark" style="color:red;float: right">
                        + Create Roles</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="bg-secondary rounded h-100 p-4">
                <div class="data-tables">
                    <table class="table table-striped" id="roleinfo" width="100%" style="text-align: center;">
                        ...
                        <tbody>
                            @forelse ($roles as $role)
                                <tr class="">
                                    ...
                                    <td>
                                        <a href="{{ route('admin.userroles.edit', $role->id) }}" type="button"
                                            class="btn btn-primary btn-sm mt-2"><i class="bi bi-pencil-square"></i></a>
                                        <a href="{{ route('admin.userroles.destroy', $role->id) }}"
                                        ...
                                        <form id="delete-role-{{ $role->id }}"
                                            action="{{ route('admin.userroles.destroy', $role->id) }}" method="post">
                                            @method('delete')
                                            @csrf
                                        </form>
                                    </td>
