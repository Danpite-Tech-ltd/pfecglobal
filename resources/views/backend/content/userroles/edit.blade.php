...
<div class="container-fluid pt-4 px-4">
    <form name="form" id="UpdateRole" method="POST" action="{{ route('admin.userroles.update', $role->id) }}"
            ...
            <div class="col-sm-12 col-xl-12">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="row">
                        <div class="col-9">
                            <div class="mb-3">
                                <input type="text" class="form-control" value="{{ $role->name }}" id="roleName"
                                    name="roleName">
                            </div>
                        </div>
                        <div class="col-3">
                            ...
                            <div class="col-3 mb-4">
                                <div class="d-flex align-items-center border-bottom py-2"
                                    ...
                                    <input class="form-check-input m-0" type="checkbox"
                                        id="{{ $i }}Management" value="{{ $permission_group->name }}"
                                        onclick="chekPermissionsByGroup('role-{{ $i }}-management-checkbox',this)"
