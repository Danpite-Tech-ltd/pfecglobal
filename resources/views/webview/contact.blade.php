                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 contact-left">
                        ...
                        <div class="contact-image">
                            <img src="{{ asset('public/contact-us-image.webp') }}" alt="">
                        </div>
                    </div>
                        ...
                        <div class="form-card">
                            ...
                            <form action="{{ url('contact-post') }}" method="POST">
                                ...
                                <div class="mb-3 phone-group">
                                    <input type="text" class="form-control code" value="+880" readonly>
                                    <input type="number" class="form-control" placeholder="Mobile Number" name="phone"
                                        maxlength="10" required>
                                </div>

                                <div class="mb-3">
                                    <select class="form-select" name="office_address" required>
                                ...
                                <div class="mb-3">
                                    <select class="form-select" name="english_status" required>
                                        ...
                                        <option value="My exams are scheduled or waiting for results">My exams are scheduled
                                            or waiting for results</option>
                                        <option value="I have not appeared for any exams">I have not appeared for any exams
                                        </option>
                                        <option value="I am planning to reappear soon">I am planning to reappear soon
                                        </option>
                                    </select>
                                </div>

                                <div class="mb-3">
                                    <select class="form-select" name="your_studies">
                                        <option>How do you plan to fund your studies</option>
                                        <option value="I have my own funds">I have my own funds</option>
                                        <option value="I am looking for education loans">I am looking for education loans
                                        </option>
                                        <option value="My parents or siblings will fund my studies">My parents or siblings
                                            will fund my studies</option>
                                ...
                                <div class="mb-2 form-check">
                                    ...
                                    <label class="form-check-label small">
                                        I agree to PFEC's Privacy Policy and consent to receive marketing and transactional
                                        updates via RCS, SMS, WhatsApp, and Email.
                                    </label>
                                </div>
